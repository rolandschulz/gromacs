...
/* Copies dd which is needed for buffered writing. Partly deep, partly shallow copy. */

int allocate_dd_buf(gmx_domdec_t ***dd_buf, t_commrec *cr);
/* Allocates dd and substructures/subarrays for storing several gmx_domdec_t's.
...
/* Used in-place of dd_collect_vec when frames are buffered for parallel IO. 
