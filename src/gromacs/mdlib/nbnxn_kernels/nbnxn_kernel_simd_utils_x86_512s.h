...
typedef __m256 gmx_mm_hpr; /* high half is ignored */
...
gmx_load1p1_pr(gmx_simd_float_t *a, const real *b)
{
  ...
  *a = _mm512_shuffle_f32x4(_mm512_broadcastss_ps(_mm_load_ss(b)),
			    _mm512_broadcastss_ps(_mm_load_ss(b+1)), 0x44);
...
{
  //*a = _mm512_castpd_ps(_mm512_extload_pd((const double*)b, _MM_UPCONV_PD_NONE, _MM_BROADCAST_4X8, _MM_HINT_NONE));
  *a = _mm512_castpd_ps(_mm512_broadcast_f64x4(_mm256_load_pd((const double*)(b))));
}
...
gmx_sum4_hpr(gmx_simd_float_t a, gmx_simd_float_t b)
{
    ...
    return _mm256_add_ps(_mm512_castps512_ps256(a), _mm256_castpd_ps(_mm512_extractf64x4_pd(_mm512_castps_pd(a), 1)));
}
...
gmx_mm_transpose_sum4h_pr(gmx_simd_float_t a, gmx_simd_float_t b)
{
  ...
  */
  __m512 t0, t1;
  t0 = _mm512_shuffle_f32x4(a, b, 0x88);
  t1 = _mm512_shuffle_f32x4(a, b, 0xDD);
  ...
  return _mm512_castps512_ps128(t0);
...
gmx_2hpr_to_pr(gmx_mm_hpr a, gmx_mm_hpr b, gmx_simd_float_t *c)
{
  ...
  *c = _mm512_castpd_ps(_mm512_insertf64x4(_mm512_castpd256_pd512(_mm256_castps_pd(a)), _mm256_castps_pd(b), 1));
}
             ...
             gmx_simd_float_t *ctab0_S, gmx_simd_float_t *ctab1_S)
{
  ...
  __m512 tmp1 = _mm512_castpd_ps(_mm512_i32gather_pd(_mm512_castsi512_si256(ti_S), (double *)tab_coul_F, sizeof(float)));
  __m512 tmp2 = _mm512_castpd_ps(_mm512_i32gather_pd(_mm512_extracti64x4_epi64(ti_S, 1), (double *)tab_coul_F, sizeof(float)));
  *ctab0_S = _mm512_permutex2var_ps(tmp1, _mm512_set_epi32(30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8, 6, 4, 2, 0), tmp2);
  *ctab1_S = _mm512_permutex2var_ps(tmp1, _mm512_set_epi32(31, 29, 27, 25, 23, 21, 19, 17, 15, 13, 11, 9, 7, 5, 3, 1), tmp2);
...
{
  __m512 t0, t1, t2;
  t0 = _mm512_add_ps(in0, _mm512_permute_ps(in0, 0x4E));
  t0 = _mm512_mask_add_ps(t0, avx512Int2Mask(0xCCCC), in2, _mm512_permute_ps(in2, 0x4E));
  t1 = _mm512_add_ps(in1, _mm512_permute_ps(in1, 0x4E));
  t1 = _mm512_mask_add_ps(t1, avx512Int2Mask(0xCCCC), in3, _mm512_permute_ps(in3, 0x4E));
  ...
  return _mm512_castps512_ps128(t2);
                     ...
                     gmx_simd_float_t *c6_S, gmx_simd_float_t *c12_S)
{
  ...
  idx = _mm256_loadu_si256((const __m256i*)(type+aj));
    ...
    __m512 tmp1 = _mm512_castpd_ps(_mm512_i32gather_pd(idx, (double*)nbfp0, sizeof(double)));
    __m512 tmp2 = _mm512_castpd_ps(_mm512_i32gather_pd(idx, (double*)nbfp1, sizeof(double)));

    *c6_S  = _mm512_permutex2var_ps(tmp1, _mm512_set_epi32(30, 28, 26, 24, 22, 20, 18, 16, 14, 12, 10, 8, 6, 4, 2, 0), tmp2);
    *c12_S = _mm512_permutex2var_ps(tmp1, _mm512_set_epi32(31, 29, 27, 25, 23, 21, 19, 17, 15, 13, 11, 9, 7, 5, 3, 1), tmp2);    
}
